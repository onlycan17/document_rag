...
class MainController:
    ...
    def initialize_session_state(self) -> None:
        ...
        if 'document_loader' not in st.session_state:
            from src.loaders.document_loader_refactored import DocumentLoader
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'is_local': st.session_state.get('current_provider') == 'local'
        }
    ...
    def get_vector_db_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'is_initialized': vector_db is not None
        }
    ...
    def update_preprocessing_settings(self, settings: Dict[str, Any]) -> None:
        ...
        st.session_state.document_loader = DocumentLoader(
            ...
            preprocessing_model=settings.get('selected_preprocessing_model', 'local'),
