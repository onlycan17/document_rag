...
class QualityChecker(BaseAgent):
    ...
    def analyze_quality(self, md_file_path: str) -> Dict[str, Any]:
        ...
        # 개선 제안 생성
        improvements = self._generate_improvements(sentence_score, spacing_score, context_score, structure_score)
...
문맥 연결성 점수 (0-100): """
    ...
    def _generate_improvements(
        self, sentence_score: float, spacing_score: float, context_score: float, structure_score: float
    ) -> List[str]:
        """
        점수 기반 개선 제안 생성
        """
