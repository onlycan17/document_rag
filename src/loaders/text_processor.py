...
class TextProcessor:
    ...
    def __init__(self):
        ...
        # 정제 패턴들
        self.cleaning_patterns = self._init_cleaning_patterns()
    ...
    def _init_markdown_patterns(self) -> Dict[str, Any]:
        """마크다운 관련 패턴 초기화"""
        return {
            # 헤더 패턴
    ...
    def _init_cleaning_patterns(self) -> Dict[str, Any]:
        """텍스트 정제 패턴 초기화"""
        return {
            # 불필요한 공백 패턴
    ...
    def _init_korean_patterns(self) -> Dict[str, Any]:
        """한국어 처리 관련 패턴 초기화"""
        return {
            # 한국어 문장 패턴
    ...
    def _init_structure_patterns(self) -> Dict[str, Any]:
        """구조 보존 관련 패턴 초기화"""
        return {
            # 섹션 패턴
    ...
    def extract_structure_info(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for match in self.structure_patterns['bulleted_items'].finditer(text):
                structure["bulleted_items"].append({
        ...
        try:
            ...
            for text in texts:
                ...
                for existing in unique_texts:
                    ...
                    # 길이 차이가 크면 스킵
                    if abs(len(normalized) - len(existing_normalized)) > max(len(normalized), len(existing_normalized)) * (1 - similarity_threshold):
                        continue
    ...
    def process_documents(self, documents: List[Document], 
                         ...
                         remove_duplicates: bool = True) -> List[Document]:
        """
        문서 리스트 일괄 처리
