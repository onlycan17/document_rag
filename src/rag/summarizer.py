...
요약:"""
    ...
    def create_document_summary(self, 
                              document: Document, 
                              query: str = "",
                              target_length: int = None) -> DocumentSummary:
        """단일 문서 요약 생성"""
    ...
    def create_multi_level_summary(self, 
            ...
            if level < levels - 1:
                ...
                for summary in level_summaries:
                    new_doc = Document(
                        ...
                        metadata={'level': level + 1, 'compressed': True}
                    )
        ...
        if self.llm and len(final_content) > self.max_summary_length:
            final_summary = self._generate_llm_summary(
                final_content, 
                query, 
